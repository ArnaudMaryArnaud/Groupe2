...
public class HomeController {
	...
	public String addCompte(Model model, Comptes c, Long codeEmploye,
			Long codeClient) {
	...
	public String Retrait(Model model, double montant, Long numCompte,
			Long codeEmploye) {
	...
	public String Versement(Model model, double montant, Long numCompte,
			Long codeEmploye) {
	...
	public String Virement(Model model, double montant, Long compteRetrait,
			Long compteVersement, Long codeEmploye) {

		metier.effectuervirement(montant, compteRetrait, compteVersement,
				codeEmploye);
		model.addAttribute("comptes", metier.consultercompte());
	...
	public String homeEmploye(Model model) {
		...
		model.addAttribute("model", new Employe());
		return "Employes";
	}

	/* Ajout d'un employe */
	@RequestMapping(value = "/insereremploye", method = RequestMethod.GET)
	public String addEmploye(@ModelAttribute("model") @Valid Employe e,
			BindingResult resultat) {
		if (resultat.hasErrors()) {
			return "Employes";
		}
		metier.addemploye(e);
		return "redirect:addemployesuccess";
	}

	/* Succes lors de l'ajout d'un employe */
	@RequestMapping(value = "addemployesuccess")
	public String addemployesuccess(Model model) {
	...
	public String addEmployeGroupe(Model model, Long codeGroupe,
			Long codeEmploye) {
	...
	public String employedugroupe(Model model, Long codeGroupe) {
		...
		model.addAttribute("EmployeGroupe",
				metier.consulteremployesgroupe(codeGroupe));
		return "Employes";
	}
	...
	public String compteEmploye(Model model, Long codeEmploye) {
		...
		model.addAttribute("Comptes",
				metier.consultercompteemploye(codeEmploye));
		return "Employes";
	}
