	...
	<div class="col-xs-12">
		...
		<div>
			...
			<ul class="nav nav-tabs" role="tablist">
				...
				<li role="presentation"><a href="#Groupe"
					aria-controls="groupe" role="tab" data-toggle="tab">Groupe</a></li>
			</ul>
			<!-- Onglet Employé -->
					...
					<div class="row">
						...
						<div class="col-lg-6">
							...
							<form class="form-inline" action="addemployegroupe" method="">
								<div class="form-group">
									<label for="nom">Code Employé</label> <select id="select"
										name="codeEmploye">
										<c:forEach items="${Employe}" var="em">
											<option value="${em.codeEmploye}">${em.nomEmploye}</option>
										</c:forEach>
									</select> <label for="nom">Code Groupe</label> <select id="select"
										name="codeGroupe">
